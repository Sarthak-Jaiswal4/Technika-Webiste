...
function Glimpse_Home() {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-[100vh] bg-black relative bg-blur"
    >
      <div ref={h1Ref} className="w-full h-full flex justify-center items-center flex-col gap-4 font-[main-font]">
        <h1 className="text-white text-2xl z-[999] font-bold">Get a Glimpse</h1>
        <h1 className="text-white text-4xl w-[45vw] text-center leading-11 tracking-widest z-[999]">Get a glimpse of the electrifying innovations, exciting challenges, and unforgettable moments that define our technical fest!</h1>
      </div>
      <div className="w-full h-full" id="smooth-content">
        <img
          ref={(el) => (imagesRef.current[0] = el)}
          data-speed="0.5"
          src={`/mariola-grobelska-gxcukNe9tKs-unsplash-min.jpg`}
          alt="Image 1"
